...
namespace chrono::vehicle
{
  ...
  class WheeledVehicleForce : public ChWheeledVehicle
  {
  public:
    ...
    WheeledVehicleForce(const std::string &filename,
    ...
    WheeledVehicleForce(ChSystem *system,
  ...
  private:
    ...
    std::vector<ChVector3<>> m_susp_locations; // locations of the suspensions relative to chassis
    std::vector<ChVector3<>> m_arb_locations;  // locations of the antirollbar subsystems relative to chassis
    ...
    std::vector<ChVector3<>> m_str_locations;     // locations of the steering subsystems relative to chassis
    ...
    std::vector<ChVector3<>> m_subch_locations; // locations of the subchassis subsystems relative to chassis
