...
#ifndef CH_SALAANISTITIRE_H
#define CH_SALAANISTITIRE_H
...
/// Salaani STI tire model.
class CH_VEHICLE_API ChSalaaniStiTire : public ChForceElementTire {
  public:
    ChSalaaniStiTire(const std::string& name);

    virtual ~ChSalaaniStiTire() {}

    /// Get the name of the vehicle subsystem template.
    virtual std::string GetTemplateName() const override { return "SalaaniStiTire"; }
  ...
  protected:
    /// Set the parameters in the SalaaniSti model.
    virtual void SetSalaaniStiParams() = 0;
