...
#include "src/tire/ChSalaaniStiTire.h"

namespace chrono {
namespace vehicle {

ChSalaaniStiTire::ChSalaaniStiTire(const std::string& name)
...
// -----------------------------------------------------------------------------
void ChSalaaniStiTire::Initialize(std::shared_ptr<ChWheel> wheel) {
...
void ChSalaaniStiTire::Synchronize(double time, const ChTerrain& terrain) {
...
void ChSalaaniStiTire::Advance(double step) {
...
void ChSalaaniStiTire::CombinedCoulombForces(double& fx, double& fy, double fz, double muscale) {
    ChVector2d F;
    /*
